...
(
	...
	created_at           timestamp default CURRENT_TIMESTAMP not null comment 'The time the measurement record was created',
	updated_at           timestamp default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment 'The time the measurement record last modified',
	...
	deleted_at           datetime                            null comment 'Variable category id',
	user_variable_id     int unsigned                        not null comment 'Name of the application or device',
	connection_id        int(11) unsigned                    null comment 'ID of the user API connection from which the measurement was made',
	connector_import_id  int(11) unsigned                    null comment 'ID of the user API connection from which the measurement was made',
