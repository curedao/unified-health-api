...
(
    ...
    constraint correlations_aggregate_correlations_id_fk
        foreign key (aggregate_correlation_id) references qm_aggregate_correlations (id),
    constraint correlations_cause_unit_id_fk
        foreign key (cause_unit_id) references qm_units (id),
    constraint correlations_cause_variable_category_id_fk
        foreign key (cause_variable_category_id) references qm_variable_categories (id),
    constraint correlations_cause_variable_id_fk
        foreign key (cause_variable_id) references qm_variables (id),
    ...
    constraint correlations_effect_variable_category_id_fk
        foreign key (effect_variable_category_id) references qm_variable_categories (id),
    constraint correlations_effect_variable_id_fk
        foreign key (effect_variable_id) references qm_variables (id),
    constraint correlations_user_id_fk
        foreign key (user_id) references users (id),
    constraint correlations_user_variables_cause_user_variable_id_fk
        foreign key (cause_user_variable_id) references qm_user_variables (id)
            on update cascade on delete cascade,
    constraint correlations_user_variables_effect_user_variable_id_fk
        foreign key (effect_user_variable_id) references qm_user_variables (id)
            on update cascade on delete cascade
)
