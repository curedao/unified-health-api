create table global_data.tracking_reminders
(
    ...
    constraint tracking_reminders_user_variables_user_id_variable_id_fk
        foreign key (user_id, variable_id) references global_data.user_variables (user_id, variable_id),
...
create index tracking_reminders_user_variables_variable_id_user_id_fk
    on global_data.tracking_reminders (variable_id, user_id);

create index user_client
    on global_data.tracking_reminders (user_id, client_id);
