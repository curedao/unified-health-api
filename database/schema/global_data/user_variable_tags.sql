create table global_data.user_variable_tags
(
    ...
    constraint user_tags_tag_user_variable_id_fk
        foreign key (tag_user_variable_id) references global_data.user_variables (id),
    constraint user_tags_tag_variable_id_variables_id_fk
        foreign key (tag_variable_id) references global_data.global_variables (id),
    constraint user_tags_tagged_user_variable_id_fk
        foreign key (tagged_user_variable_id) references global_data.user_variables (id),
    constraint user_tags_tagged_variable_id_variables_id_fk
        foreign key (tagged_variable_id) references global_data.global_variables (id),
...
create index fk_conversionUnit
    on global_data.user_variable_tags (tag_variable_id);
