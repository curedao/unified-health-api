create table global_data.global_study_votes
(
    ...
    constraint votes_correlations_id_fk
        foreign key (correlation_id) references global_data.user_study_results (id),
...
create index votes_cause_variable_id_index
    on global_data.global_study_votes (cause_variable_id);

create index votes_effect_variable_id_index
    on global_data.global_study_votes (effect_variable_id);
