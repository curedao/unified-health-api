create table global_data.intuitive_condition_treatment
(
    ...
    constraint ct_condition_treatment_conditions_id_fk
        foreign key (condition_id) references global_data.intuitive_conditions (id),
    ...
    constraint ct_condition_treatment_variables_id_fk_2
        foreign key (condition_variable_id) references global_data.global_variables (id)
)
