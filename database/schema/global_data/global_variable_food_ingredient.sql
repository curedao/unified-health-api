create table global_data.global_variable_food_ingredient
(
...
mean value as a function of the number of data points.',
    ...
    constraint common_tags_tag_variable_id_variables_id_fk
        foreign key (ingredient_global_variable_id) references global_data.global_variables (id),
    constraint common_tags_tag_variable_unit_id_fk
        foreign key (ingredient_global_variable_unit_id) references global_data.units (id),
    constraint common_tags_tagged_variable_id_variables_id_fk
        foreign key (food_global_variable_id) references global_data.global_variables (id),
    constraint common_tags_tagged_variable_unit_id_fk
        foreign key (food_global_variable_unit_id) references global_data.units (id)
)
