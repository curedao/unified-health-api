create table global_data.intuitive_condition_symptom
(
    ...
    constraint ct_condition_symptom_symptoms_fk
        foreign key (symptom_id) references global_data.intuitive_symptoms (id),
    ...
    constraint ct_condition_symptom_variables_symptom_fk
        foreign key (symptom_variable_id) references global_data.global_variables (id)
)
