create table global_data.intutitive_treatment_side_effect
(
    ...
    constraint side_effect_variables_id_fk
        foreign key (side_effect_variable_id) references global_data.global_variables (id),
    constraint treatment_side_effect_side_effects_id_fk
        foreign key (side_effect_id) references global_data.intuitive_side_effects (id),
    constraint treatment_side_effect_treatments_id_fk
        foreign key (treatment_id) references global_data.intuitive_treatments (id),
    constraint treatment_variables_id_fk
        foreign key (treatment_variable_id) references global_data.global_variables (id)
)
