...
(
    ...
    constraint measurements_connections_id_fk
        foreign key (connection_id) references qm_connections (id),
    constraint measurements_connector_imports_id_fk
        foreign key (connector_import_id) references qm_connector_imports (id),
    constraint measurements_connectors_id_fk
        foreign key (connector_id) references qm_connectors (id),
    constraint measurements_original_unit_id_fk
        foreign key (original_unit_id) references qm_units (id),
    constraint measurements_unit_id_fk
        foreign key (unit_id) references qm_units (id),
    constraint measurements_user_id_fk
        foreign key (user_id) references users (id),
    constraint measurements_user_variables_user_variable_id_fk
        foreign key (user_variable_id) references qm_user_variables (id),
