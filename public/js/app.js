...
/* harmony import */ var clockwork_browser_metrics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! clockwork-browser/metrics */ "./node_modules/clockwork-browser/metrics.js");
/* harmony import */ var clockwork_browser_toolbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! clockwork-browser/toolbar */ "./node_modules/clockwork-browser/toolbar.js");
...
/***/ "./node_modules/clockwork-browser/metrics.js":
/*!***************************************************!*\
  !*** ./node_modules/clockwork-browser/metrics.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _metrics_metrics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./metrics/metrics */ "./node_modules/clockwork-browser/metrics/metrics.js");


let metrics = new _metrics_metrics__WEBPACK_IMPORTED_MODULE_0__["default"]()
...
/***/ "./node_modules/clockwork-browser/metrics/metrics.js":
/*!***********************************************************!*\
  !*** ./node_modules/clockwork-browser/metrics/metrics.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var web_vitals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! web-vitals */ "./node_modules/web-vitals/dist/web-vitals.es5.min.js");
...
class Metrics
{
	...
	collectVitals() {
		...
		;(0,web_vitals__WEBPACK_IMPORTED_MODULE_0__.getCLS)(v => this.updateVitals('cls', v.value))
		;(0,web_vitals__WEBPACK_IMPORTED_MODULE_0__.getFID)(v => this.updateVitals('fid', v.value))
		;(0,web_vitals__WEBPACK_IMPORTED_MODULE_0__.getLCP)(v => this.updateVitals('lcp', v.value))
		;(0,web_vitals__WEBPACK_IMPORTED_MODULE_0__.getFCP)(v => this.updateVitals('fcp', v.value))
		;(0,web_vitals__WEBPACK_IMPORTED_MODULE_0__.getTTFB)(v => this.updateVitals('ttfb', v.value))
	}
...
/***/ "./node_modules/clockwork-browser/toolbar.js":
/*!***************************************************!*\
  !*** ./node_modules/clockwork-browser/toolbar.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _toolbar_toolbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolbar/toolbar */ "./node_modules/clockwork-browser/toolbar/toolbar.js");


let toolbar = new _toolbar_toolbar__WEBPACK_IMPORTED_MODULE_0__["default"]
...
/***/ "./node_modules/clockwork-browser/toolbar/icons.js":
/*!*********************************************************!*\
  !*** ./node_modules/clockwork-browser/toolbar/icons.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/clockwork-browser/toolbar/request.js":
/*!***********************************************************!*\
  !*** ./node_modules/clockwork-browser/toolbar/request.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/clockwork-browser/toolbar/styles.js":
/*!**********************************************************!*\
  !*** ./node_modules/clockwork-browser/toolbar/styles.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/clockwork-browser/toolbar/toolbar.js":
/*!***********************************************************!*\
  !*** ./node_modules/clockwork-browser/toolbar/toolbar.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icons */ "./node_modules/clockwork-browser/toolbar/icons.js");
/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./request */ "./node_modules/clockwork-browser/toolbar/request.js");
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles */ "./node_modules/clockwork-browser/toolbar/styles.js");
...
class Toolbar
{
	...
	show(attempts = 0) {
		...
		fetch(`${this.path}${this.requestId}`)
			...
			.then(request => {
				...
				this.render(new _request__WEBPACK_IMPORTED_MODULE_1__["default"](request))
			})
	}
			...
			<div class="clockwork-toolbar">
				...
				<div class="clockwork-toolbar-details">
					...
					<a href="${this.webPath}#${request.id}" target="_blank" class="clockwork-toolbar-details-button">
						${_icons__WEBPACK_IMPORTED_MODULE_0__["default"].arrowRight}
					</a>
				</div>
	...
	renderStatusSection(request) {
		...
		let statusIcon = r => {
			if (r.errorsCount || r.isServerError()) return _icons__WEBPACK_IMPORTED_MODULE_0__["default"].alertCircle
			if (r.warningsCount || r.isClientError()) return _icons__WEBPACK_IMPORTED_MODULE_0__["default"].alertTriangle
			return _icons__WEBPACK_IMPORTED_MODULE_0__["default"].check
		}
		...
		return `
			<div class="clockwork-toolbar-section">
				<div class="clockwork-toolbar-section-icon" title="${section.name}">
					${_icons__WEBPACK_IMPORTED_MODULE_0__["default"][section.icon]}
				</div>
				...
				<div class="clockwork-toolbar-section-popover ${section.popoverClasses || ''}">
					<div class="clockwork-toolbar-section-popover-content">
						<div class="clockwork-toolbar-section-popover-title">${_icons__WEBPACK_IMPORTED_MODULE_0__["default"][section.icon]} ${section.name}</div>
	...
	appendStyles() {
		...
		style.innerHTML = _styles__WEBPACK_IMPORTED_MODULE_2__["default"]
